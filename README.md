...
├── assets/                                         ← 圖片資源資料夾 (image folder)
│   └── misjudgment_rate_vs_sample_size.png         ← AIVAT 與 Raw EV 誤判率比較圖
├── Side_Project_AIVAT_Simulation_for_Poker_Strategy_Evaluation.ipynb  ← 主模擬程式 notebook
└── README.md                                       ← 專案說明文件
```
